      ...
      <div className="flex flex-wrap">
        ...
        <div className="w-full md:w-1/2 px-2">
          <div className="w-full flex flex-col mb-6">
            ...
            <div className="w-full">
              <select
                className={`w-full bg-transparent border ${errors.area ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:border-blue-600 duration-300 min-h-[48px] leading-none px-3 opacity-80`}
                id="area"
                {...register("area", { required: "Area is required" })}
              >
                <option value="United State" className="bg-white">United State</option>
                <option value="Bangladesh" className="bg-white">Bangladesh</option>
